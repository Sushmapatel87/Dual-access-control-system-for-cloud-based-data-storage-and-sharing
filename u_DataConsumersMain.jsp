    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="209" height="341" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><strong><a href="u_Search.jsp">Search Patients On Cloud</a></strong></li>
			<li><strong><a href="U_Request_SK.jsp">Request Secret Key</a></strong></li>
			<li><strong><a href="U_View_SecretKeyGen.jsp">Secret Key Response</a></strong></li>
