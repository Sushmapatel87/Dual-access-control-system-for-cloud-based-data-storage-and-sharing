	...
	{		
            ...
            <tr>
			  ...
			  <td width="127" bgcolor="#FF0000"><div align="center" class="style21 style14"><span class="style23">Blood Group</span></div></td>
			    <td width="127" bgcolor="#FF0000"><div align="center" class="style21 style14"><span class="style23">Trapdoor</span></div></td>
            </tr>
            <%
				...
				while ( rs.next() )
				{
					...
					%>
            <tr>
              <td height="65"><div align="center" class="style15"><%=i%></div></td>
              <td><div align="center" class="style15"><%=s2%></div></td>
              
             
              <td><div align="center" class="style15"><%=s4%><a href="C_View_Patient_Details_More.jsp?pname=<%=s4%>">::View Report</a></div></td>
              ...
              <td width="66"><div align="center" class="style15"><%=disease%></div></td>
			    <td width="127"><div align="center" class="style15"><%=s6%></div></td>
				 ...
				 <td width="127"><textarea name="textarea"><%=tdoor%></textarea>
