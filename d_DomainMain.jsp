...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          <h2 class="star">AC Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu style10">
            <li><a href="d_DomainMain.jsp">Home</a></li>
			  <li><a href="RA_AuthorizeOwners.jsp">View  Data Owners and Authorize</a></li>
			   <li><a href="RA_AuthorizeDataConsumerss.jsp">View Data Consumerss and Authorize </a></li>
			 <li><a href="D_View_SecretKeyGen.jsp">View Secret Key Request</a></li>
			 <li><a href="D_View_Attacker_Details.jsp">View All Attackers</a></li>
            <li><a href="d_DomainLogin.jsp">Logout</a></li>
          </ul>
        </div>
      </div>
