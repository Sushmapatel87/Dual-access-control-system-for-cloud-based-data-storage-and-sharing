...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <table width="514" border="1.5" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              <td width="76" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
	...
	int i=0,j=0,k=0;
	String daname=(String)application.getAttribute("daname");
      	try 
	{
        	String s="null";
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center" class="style27"><a href="d_OwnerDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
		...
		%>
              <td bgcolor="#FFFFFF"><div class="style27">
                  <div align="center"><a href="d_StatusOwner.jsp?id=<%=i%>"><%=s5%></a></div>
              </div></td>
              <%
