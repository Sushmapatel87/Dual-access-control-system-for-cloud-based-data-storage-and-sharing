...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="u_DataConsumersNotAuth.jsp"><span>Data Consumers</span></a></li>
    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="u_DataConsumersNotAuth.jsp">Home</a></li>
            <li><a href="u_DataConsumersLogin.jsp">Logout</a></li>
          </ul>
        </div>
      </div>
