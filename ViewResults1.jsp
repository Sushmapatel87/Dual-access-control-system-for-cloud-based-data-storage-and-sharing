...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Attacker Count Results On Each Patient  :  </span></h2>
          <p class="infopost">&nbsp;</p>
          <p class="infopost"><iframe width="625" height="350" src="Results1.jsp"></iframe> </p>
          <p align="right" class="infopost"><a href="c_CloudMain.jsp">Back</a></p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
        </div>
