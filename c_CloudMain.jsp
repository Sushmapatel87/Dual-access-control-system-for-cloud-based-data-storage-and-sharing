...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome Cloud Service Provider(CSP):  </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/gal1.jpg" width="212" height="339" alt="" class="fl" /></div>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><strong><a href="c_CloudMain.jsp">Home</a></strong></li>
			 ...
			 <li><a href="C_View_Patient_Details.jsp">View Patient Details</a></li>
			 <li><a href="C_View_Transactions_Details.jsp">View Transactions Details</a></li>
			  <li><a href="C_View_Search_Details.jsp">View Search Details</a></li>
			   <li><a href="C_View_SecretKeyGen.jsp">View Secret Key Response Details</a></li>
			  
              <li><a href="C_View_Attacker_Details.jsp">View Attacker Details</a></li>
			                <li><a href="ViewResults.jsp">View Keyword Used Results</a></li>
							<li><a href="ViewResults1.jsp">View Attacker Count Results</a></li>
