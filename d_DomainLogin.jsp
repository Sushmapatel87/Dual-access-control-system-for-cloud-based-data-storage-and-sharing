...
<head>
<title>Registry Authority Login</title>
...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
		  ...
		  <li class="active"><a href="d_DomainLogin.jsp">Registry Authority</a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Registry Authority Login :  </span></h2>
          <p class="infopost"><img src="images/Login.png" width="154" height="154" /></p>
          <form action="d_DomainAuthentication.jsp" method="post" id="leavereply">
            <label for="name"><br />
