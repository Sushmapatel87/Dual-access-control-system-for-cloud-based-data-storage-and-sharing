	...
	String pname=request.getParameter("pname");	
		String oname=request.getParameter("oname");
			...
			String sk=request.getParameter("sk");
				...
				String query="Select * from pdata where patient='"+pname+"' and oname='"+oname+"' and trapdoor='"+tdoor+"' and sk='"+sk+"' "; 
              ...
              <textarea id="ta" name="textarea" cols="50" rows="10"><%=report%></textarea>
            </p>
            <p>&nbsp;</p>
            <p>
...
String query1 ="insert into attacker values('"+user+"','"+pname+"','"+sk+"','"+dt1+"') ";
st1.executeUpdate (query1);
				
				%>
				
				<h2> Secret Key Entered is Wrong </h2>
