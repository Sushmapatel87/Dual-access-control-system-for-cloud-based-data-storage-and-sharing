...
try 
	{		
			...
			String pname=request.getParameter("pname");
				...
				String query="Select * from pdata where patient='"+pname+"' "; 
				Statement st=connection.createStatement();
				ResultSet rs=st.executeQuery(query);
				while ( rs.next() )
				{
					i=rs.getInt(1);
					s2=rs.getString(3); // Report
					...
					String report = new String(Base64.decode(s2.getBytes()));

					
					%>
					
					  <textarea name="textarea" cols="50" rows="10"><%=s2%></textarea>
...
%>
            <p><a href="C_View_Patient_Details.jsp">Back</a></p>
           <p>&nbsp;</p>
           <p>&nbsp;</p>
           <div class="clr"></div>
          <div class="clr"></div>
